...
class GetCuestionario(TemplateView):
    ...
    def post(self, request, **kwargs):
        ...
        if total/con*100>congreso.aprobado:
            ...
            nombre_font=ImageFont.truetype("/usr/share/fonts/FreeMono.ttf", 40)
            congreso_font=ImageFont.truetype("/usr/share/fonts/FreeMono.ttf", 25)
            fecha_font=ImageFont.truetype("/usr/share/fonts/FreeMono.ttf", 25)
