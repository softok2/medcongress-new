...
class vTableAsJSONEspEventos(TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        object_list = EspecialidadCongreso.objects.all()
        ...
        for objet in filtered_object_list[start:(start+delta)]:
            ...
            enviar.append({ 'nombre':objet.nombre,
                            'operaciones' : 
                                                    ''' <a href="'''+ reverse('MedCongressAdmin:esp_evento_edit',kwargs={'pk':objet.pk})+'''"
